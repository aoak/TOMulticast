...
/* Message: This class implements the messages to be sent to and from
 * the sockets. It has to implement Serializable interface so that we 
 * can send the objects over the socket instead of stuggling with sending
 * and decoding plain text data.
 */
...
public class Message implements Serializable {
	...
	/* Nothing much to explain in these methods */
